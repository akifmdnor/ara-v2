...
<div class="flex items-center px-6 py-4 mx-auto w-full bg-white rounded-2xl shadow-md">
    <!-- Car image with red ellipse shadow -->
    <div class="relative flex-shrink-0">
        <div class="absolute -bottom-2 left-1/2 z-0 w-20 h-4 bg-red-100 rounded-full blur-sm -translate-x-1/2">
        </div>
