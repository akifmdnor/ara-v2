<div class="p-6 mb-6 bg-white rounded-lg border border-gray-200 shadow-sm">
    <form @submit.prevent="handleSearch" class="space-y-4" x-data="searchFormData()">
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="pickup_location" x-ref="pickupLocation"
                                x-model="searchParams.pickup_location"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="InputStartDate" name="pickup_date" x-ref="pickupDate"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="InputStartTime" name="pickup_time" x-ref="pickupTime"
            ...
            <!-- Chevron Icon -->
            <div class="hidden md:flex justify-center items-center pt-10">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="return_location" x-ref="returnLocation"
                                x-model="searchParams.return_location"
                                class="py-3 pr-4 pl-10 w-full rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="InputReturnDate" name="return_date" x-ref="returnDate"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="InputReturnTime" name="return_time" x-ref="returnTime"
