<template>
    <div class="flex h-screen bg-gray-100">
        <!-- Sidebar -->
        <aside
            class="w-60 bg-[#EC2028] text-white flex flex-col items-center py-4"
        >
            <!-- Logo -->
            <div class="mb-4">
                <img
            ...
            >
                ...
                <div class="flex items-center gap-6">
                    <span class="text-lg font-semibold text-gray-800"
                        >Ara Car Rental - HQ</span
                    >
                    <!-- Unique Code Box -->
                    <div
                        class="bg-gray-100 px-4 py-2 rounded flex items-center gap-2"
                    >
                        <span class="text-xs text-gray-500"
                            >Your Unique Code</span
                        >
                        <span
                            class="font-mono text-base font-bold text-[#4B5563]"
                            >A1B2C3D4</span
                        >
                        <button title="Copy">
                            <svg
