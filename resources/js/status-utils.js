...
window.StatusUtils = {
     ...
     */
    generateBadge(status, size = "base") {
        ...
        return `<span class="rounded-lg font-normal whitespace-nowrap overflow-hidden text-ellipsis max-w-full ${config.bg} ${config.text} ${sizeClasses[size]}">${config.label}</span>`;
    },
